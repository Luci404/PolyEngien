...
void Sandbox2D::OnAttach()
{
	...
	m_FlatColorShader = PolyEngien::Shader::Create("assets/shaders/FlatColor.glsl");
}
...
void Sandbox2D::OnUpdate(PolyEngien::Timestep ts)
{
	...
	std::dynamic_pointer_cast<PolyEngien::OpenGLShader>(m_FlatColorShader)->UploadUniformFloat4("u_Color", m_SquareColor);

	PolyEngien::Renderer::Submit(m_FlatColorShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
