	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_Texture = PolyEngien::Texture2D::Create("assets/textures/Checkerboard.png");
...
void ExampleLayer::OnUpdate(PolyEngien::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(PolyEngien::Event& e)
{
